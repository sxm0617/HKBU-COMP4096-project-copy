...
//Rare exceptions to indicate a bug in the _shoppingapp_v8 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ShoppingApp_V8 proxies.
 */
