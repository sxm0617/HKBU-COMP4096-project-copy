...
// in simulator we redefine to format for ShoppingApp_V8 Developer console
...
{\
	NSString * exceptionName = [@"org.shoppingapp_v8." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.shoppingapp_v8";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIShoppingApp_V8NativeItemNone = -1, 
	UIShoppingApp_V8NativeItemSpinner = -2,
	UIShoppingApp_V8NativeItemProgressBar = -3,
	
	UIShoppingApp_V8NativeItemSlider = -4,
	UIShoppingApp_V8NativeItemSwitch = -5,
	UIShoppingApp_V8NativeItemMultiButton = -6,
	UIShoppingApp_V8NativeItemSegmented = -7,
	
	UIShoppingApp_V8NativeItemTextView = -8,
	UIShoppingApp_V8NativeItemTextField = -9,
	UIShoppingApp_V8NativeItemSearchBar = -10,
	
	UIShoppingApp_V8NativeItemPicker = -11,
	UIShoppingApp_V8NativeItemDatePicker = -12,
	
	UIShoppingApp_V8NativeItemInfoLight = -13,
	UIShoppingApp_V8NativeItemInfoDark = -14,
	
	UIShoppingApp_V8NativeItemDisclosure = -15,
	
	UIShoppingApp_V8NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all ShoppingApp_V8 instances of
