...
// in simulator we redefine to format for Testing Developer console
...
{\
	NSString * exceptionName = [@"org.testing." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testing";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITestingNativeItemNone = -1, 
	UITestingNativeItemSpinner = -2,
	UITestingNativeItemProgressBar = -3,
	
	UITestingNativeItemSlider = -4,
	UITestingNativeItemSwitch = -5,
	UITestingNativeItemMultiButton = -6,
	UITestingNativeItemSegmented = -7,
	
	UITestingNativeItemTextView = -8,
	UITestingNativeItemTextField = -9,
	UITestingNativeItemSearchBar = -10,
	
	UITestingNativeItemPicker = -11,
	UITestingNativeItemDatePicker = -12,
	
	UITestingNativeItemInfoLight = -13,
	UITestingNativeItemInfoDark = -14,
	
	UITestingNativeItemDisclosure = -15,
	
	UITestingNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Testing instances of
