...
@interface ShoppingApp_V8Object : KrollCoverageObject {
#else
@interface ShoppingApp_V8Object : KrollObject {
#endif
@private
...
extern NSString * ShoppingApp_V8$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ShoppingApp_V8Object *_shoppingapp_v8;
    KrollObject* console;
	BOOL shutdown;
