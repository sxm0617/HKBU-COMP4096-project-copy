...
/**
 The base class for all ShoppingApp_V8 modules
 */
...
/**
 ShoppingApp_V8 Platform calls this method on startup.
 */
-(void)startup;

/**
 ShoppingApp_V8 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ShoppingApp_V8 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ShoppingApp_V8 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ShoppingApp_V8 Platform calls this method on resume.
 @param sender The sender of the event.
 */
