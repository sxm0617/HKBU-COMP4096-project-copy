...
/**
 The base class for all Testing modules
 */
...
/**
 Testing Platform calls this method on startup.
 */
-(void)startup;

/**
 Testing Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Testing Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Testing Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Testing Platform calls this method on resume.
 @param sender The sender of the event.
 */
