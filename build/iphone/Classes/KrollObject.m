...
//@interface ShoppingApp_V8Object : NSObject
//@end

@interface ShoppingApp_V8Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ShoppingApp_V8Object class]])
		{
			for (NSString *key in [[(ShoppingApp_V8Object*)o modules] allKeys])
			{
