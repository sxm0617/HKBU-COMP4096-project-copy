...
/**
 Base class for all ShoppingApp_V8 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the ShoppingApp_V8 view hierarchy (such as wrapped iOS UIViews) was touched.
